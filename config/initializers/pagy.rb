...
Pagy::DEFAULT[:items]  = Rails.application.credentials.dig(:pagy, :items_per_page) || 50 # default
...
Pagy::DEFAULT[:page_param] = :page_no                          # default
...
Pagy::DEFAULT[:headers] = { page: 'current_page',
                            items: 'page_items',
                            count: 'total_count',
                            pages: 'total_pages' }     # default
